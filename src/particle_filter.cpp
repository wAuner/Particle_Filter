...
void ParticleFilter::updateWeights(double sensor_range, double std_landmark[], 
  ...
  for (auto &particle : particles) {
    ...
    normalizer_sum += particle.weight;
  }
  // normalize particle probabilities
  for (auto &particle : particles) particle.weight /= normalizer_sum;
}
...
// returns the probability of an x,y point according to the multivariate normal
